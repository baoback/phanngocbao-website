---
title: Dự án Robotics For Education
description: Xây dựng Otto DIY robot, sản phẩm giúp trẻ em từ 6-15 tuổi làm quen
  với lập trình, STEM
cover: /uploads/720x720-otto-diy-11.jpg
...
phases:
  - label: Milestone 1
    text: "Triển khai các hoạt động bán hàng đồ cho trẻ em (toys) nhằm phát triển
      cộng đồng "
  - label: Milestone 2
    text: |-
      Triển khai in 3D các mô hình robot Otto
      Lập trình các Module cho robot
  - label: "Milestone 3 "
    text: |-
      Triển khai bán hàng đa kênh
      Phát triển hệ thống sư phạm
  - label: Milestone 4 (expected)
    text: Đưa vào làm chương trình giảng dạy ở các trường học
metrics:
  - value: 2k+
    caption: Sản phẩm đồ chơi mình đã bán được cho dự án
    percent: 80
  - value: 10+
    caption: Số lượng prototype robot mình tham gia xây dựng
    percent: 75
  - value: Dự án vẫn đang triển khai
    caption: Mình đã không còn tham gia dự án từ Milestone 3
---
