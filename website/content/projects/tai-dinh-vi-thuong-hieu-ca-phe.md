...
cover: /uploads/giu-lanh-cuc-sau-3.png
...
phases:
  - label: Milestone 1
    text: |
      Nghiên cứu sản phẩm, khách hàng, xác định lợi thế cạnh tranh cốt lõi 
      Triển khai các kịch bản quản trị tài chính, projection
  - label: Milestone 2
    text: |-
      Break Even

      Đạt điểm hoà vốn sau 2 tháng hoạt động
  - label: Milestone 3 ( Hiện tại)
    text: |-
      Triển khai hợp tác với các đối tác chiến lược
      Mở rộng quy mô thị trường
  - label: Milestone 4
    text: Triển khai độc quyền với 1 số sản phẩm chiến lược của thị trường
metrics:
  - value: 10+
    caption: Trên 10 đối tác là các brand điện tử, điện gia dụng lớn
    percent: 75
  - value: 2 tháng
    caption: Thời gian để đạt Break Even
    percent: 70
  - value: Dự án thành công
    caption: Đánh giá đây là 1 dự án thành công xét về mặt tài chính và đầu tư
---
